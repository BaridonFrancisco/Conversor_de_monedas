...
* Mostrar informacion sobre las solicitudes
...
- [x] Obtener su api key
- [x] Descargar el JRE de java para poder ejecutarlo
- [x] Descargar el archivo jar
